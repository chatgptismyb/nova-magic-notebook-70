    ...
    <section className="py-24 px-6 relative bg-transparent">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-500/20 to-yellow-500/20 px-6 py-3 rounded-full border border-purple-400/30 mb-6 backdrop-blur-sm">
            <div className="text-2xl animate-bounce">❓</div>
            <span className="text-purple-200 font-semibold">Frequently Asked Questions</span>
          </div>
        ...
        <div className="space-y-4">
          {faqItems.map((item, index) => (
            <div
              key={index}
              className="bg-gradient-to-r from-slate-800/60 via-slate-900/60 to-slate-800/60 rounded-2xl border border-purple-400/20 backdrop-blur-sm overflow-hidden hover:border-purple-400/40 transition-all duration-300 group"
            >
              <button
                onClick={() => toggleFAQ(index)}
                className="w-full p-6 text-left flex items-center justify-between hover:bg-purple-500/10 transition-all duration-300"
              >
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-purple-500/20 to-yellow-500/20 rounded-full flex items-center justify-center border border-purple-400/30 group-hover:scale-110 transition-transform duration-300">
                    {item.icon}
                  </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-600/20 via-purple-500/20 to-yellow-500/20 p-8 rounded-3xl border border-purple-400/30 backdrop-blur-sm relative overflow-hidden">
            {/* Background sparkles */}
            <div className="absolute inset-0 pointer-events-none">
              {[...Array(12)].map((_, i) => (
                <div
                  key={i}
                  className="absolute text-purple-300/20 animate-ping"
                  style={{
                    left: `${Math.random() * 100}%`,
                    top: `${Math.random() * 100}%`,
            ...
            <div className="relative z-10">
              ...
              <button className="bg-gradient-to-r from-purple-600 to-yellow-600 hover:from-purple-700 hover:to-yellow-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-purple-500/25">
