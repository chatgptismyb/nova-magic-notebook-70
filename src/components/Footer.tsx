    ...
    <footer className="py-12 px-6 border-t border-slate-800/50 relative">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-purple-300">Magic Notebook</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-purple-300 transition-colors">🎓 Spell Academy</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><a href="#" className="hover:text-purple-300 transition-colors">🛠️ Status</a></li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-slate-800/50">
          <div className="flex items-center gap-4 mb-4 md:mb-0">
            <div className="text-2xl hover:animate-pulse cursor-pointer">🧙‍♀️</div>
          ...
          <div className="flex items-center gap-4">
            <input
              ...
              className="bg-slate-800/50 border border-slate-700 rounded-lg px-3 py-1 text-sm text-gray-300 focus:outline-none focus:border-purple-500 transition-colors"
            />
            {secretRevealed && (
