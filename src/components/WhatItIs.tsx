      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="bg-slate-800/50 p-6 rounded-xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
              <h3 className="text-2xl font-semibold mb-4 text-purple-300">Voice-Powered Magic</h3>
              <p className="text-gray-300">Speak or write your thoughts. Nova transforms them into organized, actionable spells.</p>
            </div>
            
            <div className="bg-slate-800/50 p-6 rounded-xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300">
              <h3 className="text-2xl font-semibold mb-4 text-blue-300">Intelligent Automation</h3>
              <p className="text-gray-300">Connect with your favorite tools through magical automation that learns your workflow.</p>
            </div>
            
            <div className="bg-slate-800/50 p-6 rounded-xl border border-pink-500/20 hover:border-pink-500/40 transition-all duration-300">
              <h3 className="text-2xl font-semibold mb-4 text-pink-300">Multi-Step Spells</h3>
              <p className="text-gray-300">Chain complex tasks together with Nova's understanding of your goals and context.</p>
            </div>
          </div>
          
          <div className="relative">
            <div className="bg-slate-900/80 p-8 rounded-2xl border border-purple-500/30 shadow-2xl">
              <div className="mb-4">
              ...
              <div className="space-y-3 text-sm font-mono">
                <div className="text-purple-400">📝 New spell detected...</div>
                ...
                <div className="text-purple-400 animate-pulse">🔮 Spells ready to cast!</div>
              </div>
            </div>
          </div>
        </div>
