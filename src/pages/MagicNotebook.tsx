      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-3 border-2 border-purple-200 shadow-lg">
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <h1 className="text-xl font-bold text-purple-800">Magic Notebook</h1>
                  <p className="text-sm text-purple-600">Powered by Nova AI</p>
                </div>
              </div>
            </div>
            
            <Button variant="outline" size="icon" className="border-purple-300 hover:bg-purple-100">
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl border-2 border-purple-200 p-6 shadow-xl">
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-purple-100 to-yellow-100 rounded-xl border border-purple-200">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl border-2 border-purple-200 shadow-xl overflow-hidden">
              ...
              <div className="h-[600px] overflow-y-auto p-6 space-y-4">
                {messages.map((message) => (
                  ...
                  >
                    {message.type === 'nova' && (
                      <div className="w-10 h-10 bg-gradient-to-br from-purple-400 to-yellow-400 rounded-full flex items-center justify-center shadow-lg animate-pulse">
                        <img 
                          src="/lovable-uploads/c7ece047-1e18-4f14-a65c-f13365eedddc.png" 
                          alt="Nova" 
                    ...
                    <div className={`max-w-md rounded-2xl p-4 shadow-lg animate-fade-in ${
                      message.type === 'user' 
                        ...
                        : message.type === 'nova'
                        ? 'bg-gradient-to-r from-yellow-100 to-purple-100 border-2 border-purple-200 text-purple-800'
                ...
                {isLoading && (
                  <div className="flex gap-3">
                    ...
                    <div className="bg-gradient-to-r from-yellow-100 to-purple-100 border-2 border-purple-200 rounded-2xl p-4 shadow-lg">
              ...
              {/* Input Area */}
              <div className="border-t-2 border-purple-200 p-6 bg-gradient-to-r from-purple-50 to-yellow-50">
                <div className="flex gap-3">
                  <button
                  ...
                  <button
                    ...
                    className="p-3 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-500 text-white rounded-xl transition-all duration-300 hover:scale-105 shadow-lg disabled:cursor-not-allowed disabled:scale-100 flex items-center gap-2"
                  >
